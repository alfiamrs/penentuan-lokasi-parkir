...
class GuiMain:
    ...
    def __init__(self):
        ...
        for i in range(10):
            if i < 5:
                self.park = Label(park_segment0, width=15, text=str(i+1), style='start.TLabel',
                                  borderwidth=2, relief='sunken')
                self.park.grid(row=0, column=i, sticky='ew', pady=20,
                                padx=20, ipady=10, ipadx=5)  # Posisi gambar yang ditampilkan
            else:
                self.park = Label(park_segment1, width=15, text=str(i+1), style='start.TLabel',
                                  borderwidth=2, relief='sunken')
        ...
        self.counter_kosong.grid(row=1, column=3, sticky='ew',
                                 ipady=10, pady=10)
        self.show_log.grid(row=1, column=4, sticky='ew',
                           ipadx=5, padx=10)
    ...
    def start_opencv(self):
        ...
        if len(self.nopol_list) <= 10:
            ...
            if len([i for i in self.nopol_list if i =='']) == 0:
                if counter > 0:
                    ...
                    if len(imgs) < counter:
                        ...
                        messagebox.showinfo('Perhatian',
                                            ...
                                            'karena parkir telah penuh!'.format(len(imgs) - counter))
